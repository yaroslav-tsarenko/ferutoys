...
export const DEPARTMENTS: Department[] = [
  {
    ...
    subs: [
      { label: "For Her", slug: "erotic-toys-clitoral-suction-17170" },
      { label: "For Him", slug: "erotic-toys-prostate-massage-devices-17116" },
      { label: "For Couples", slug: "vibrators-couple-vibrators-17178" },
      { label: "For Everyone", slug: "erotic-toys-vibrators-17172" },
      { label: "LGBTQ+ Friendly", slug: "dildos-dildos-with-harnesses-27555" },
      { label: "Beginners", slug: "erotic-toys-kits-17158" },
    ],
    promo: {
