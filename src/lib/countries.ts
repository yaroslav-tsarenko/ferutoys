...
// Based on EU/UK/OFAC sanctions and export restrictions.
const SANCTIONED = new Set([
  ...
  "ER", // Eritrea
  "GW", // Guinea-Bissau
  "LB", // Lebanon (partial — full block for simplicity)
  "IQ", // Iraq (partial — full block for simplicity)
]);
...
const ALL_COUNTRIES = [
  ...
  { code: "AX", name: "Aland Islands", phone: "+358" },
  ...
  { code: "VA", name: "Vatican City", phone: "+379" },
