...
export const metadata = { title: "Privacy Policy — FeruToys" };

export default function PrivacyPolicyPage() {
  return (
    <PolicyLayout title="Privacy Policy" lastUpdated="29 May 2026">
      <p>
        This Privacy Policy explains how FERUTAX OÜ, trading as FeruToys, collects, uses, stores, shares,
        and protects personal data when you visit www.ferutoys.com, create an account, place an order,
        contact us, use our services, or otherwise interact with us.
      </p>
      <p>The Website is operated by:</p>
      <ContactBlock />
      <p>
        In this Privacy Policy, &ldquo;FeruToys&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo; or
        &ldquo;our&rdquo; means FERUTAX OÜ. &ldquo;Customer&rdquo;, &ldquo;you&rdquo; or
      ...
      <p>
        2.1 For the purposes of applicable data protection laws, including the EU General Data Protection
        Regulation (Regulation (EU) 2016/679) and the Estonian Personal Data Protection Act
        (Isikuandmete kaitse seadus), FERUTAX OÜ is the data controller of your personal data.
      </p>
      ...
      <p>3.1 The personal data we collect depends on how you interact with FeruToys.</p>
      ...
      <p>
        ...
        the relevant email or contacting us at info@ferutoys.com.
      </p>
      <p>
      ...
      <p>
        11.1 Because FeruToys sells internationally and uses third-party service providers, your personal
        data may be processed outside Estonia, the European Economic Area, or your country of
        residence.
      </p>
      <p>
      ...
      <ul>
        ...
        <li>binding corporate rules, where a provider operates them;</li>
      ...
      <p>14.3 To exercise your rights, please contact us at info@ferutoys.com.</p>
      ...
      <p>
        ...
        info@ferutoys.com so we can try to resolve the matter.
      </p>
      <p>
        15.2 As we are established in Estonia, you have the right to lodge a complaint with the Estonian
        Data Protection Inspectorate (Andmekaitse Inspektsioon, www.aki.ee).
      </p>
      <p>
        15.3 If you are elsewhere in the European Union or European Economic Area, you may also lodge a
      ...
      <p>
        ...
        info@ferutoys.com and we will take appropriate steps to review and delete the information where
        required.
      </p>
