...
export default function CookiePolicyPage() {
  return (
    <PolicyLayout title="Cookie Policy" lastUpdated="29 May 2026">
      <p>
        This Cookie Policy explains how FERUTAX OÜ, trading as FeruToys, uses cookies and similar
        technologies on www.ferutoys.com.
      </p>
      <p>The Website is operated by:</p>
      <ContactBlock />
      <p>
        In this Cookie Policy, &ldquo;FeruToys&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo; or
        &ldquo;our&rdquo; means FERUTAX OÜ. &ldquo;You&rdquo; or &ldquo;your&rdquo; means any visitor,
      ...
      <ul>
        <li>first-party cookies, set directly by FeruToys; or</li>
      ...
      <p>
        8.2 These cookies may be set by FeruToys or by third-party advertising and marketing partners.
      </p>
      <p>
      ...
      <p>9.4 FeruToys does not store your full card number or full card security code.</p>
