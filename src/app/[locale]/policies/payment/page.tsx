...
export const metadata = { title: "Payment Policy — FeruToys" };
  ...
  return (
    <PolicyLayout title="Payment Policy" lastUpdated="29 May 2026">
      ...
      <p>
        ...
        means FERUTAX OÜ. &ldquo;Customer&rdquo;, &ldquo;you&rdquo; or &ldquo;your&rdquo; means any
      ...
      <p>
        2.5 FeruToys does not control exchange rates, bank conversion fees, card issuer charges, or foreign
        transaction fees.
      </p>
      ...
      <p>
        3.4 Price changes will not affect orders already accepted by FeruToys, except where there has been
      ...
      <p>4.1 FeruToys accepts secure card payments using:</p>
      <ul>
        <li>Visa</li>
        <li>Mastercard</li>
      </ul>
      ...
      <p>
        5.3 FeruToys does not guarantee that your payment will be accepted. Payment approval depends on
      ...
      <p>6.1 FeruToys takes payment security seriously.</p>
      <p>
        6.2 Card payments are handled through secure third-party payment providers. FeruToys does not store
      ...
      <p>
        8.2 FeruToys is not responsible for payment failures caused by your bank, card issuer, payment
      ...
      <p>
        9.1 To protect customers, FeruToys, payment providers, and card networks, transactions may be
      ...
      <p>
        10.3 Where applicable, FeruToys may issue order confirmations, payment confirmations, receipts, VAT
      ...
      <p>12.1 FeruToys dispatches orders from within the European Union.</p>
      <p>
        12.2 For orders delivered outside the European Union, your order may be subject to customs clearance,
      ...
      <p>
        ...
        in the product price, delivery price, or payment collected by FeruToys.
      </p>
      <p>
      ...
      <p>
        12.5 FeruToys does not control customs authorities, customs delays, import tax assessments, courier
