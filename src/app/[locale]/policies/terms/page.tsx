  ...
  return (
    <PolicyLayout title="Terms and Conditions" lastUpdated="29 May 2026">
      <p>
        ...
        www.ferutoys.com and any related pages, services, orders, purchases, communications, and
        transactions operated under the FeruToys brand.
      </p>
      <p>The Website is operated by:</p>
      <ContactBlock />
      <p>
        In these Terms, &ldquo;FeruToys&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo; or &ldquo;our&rdquo; means FERUTAX OÜ.
      ...
      <p>
        ...
        account, submitting an order, or purchasing goods from FeruToys, you agree to be bound by these
        Terms.
      </p>

      <h2>1. Scope of These Terms</h2>
      <p>1.1 These Terms apply to all use of the Website and all purchases of goods made through FeruToys.</p>
      <p>
        1.2 FeruToys sells physical electrical products, electrical materials, wiring accessories,
      ...
      <p>
        2.4 You must not use the Website or purchase goods from FeruToys for any unlawful, unsafe,
        fraudulent, or unauthorised purpose.
      </p>

      <h2>3. Consumer and Business Customers</h2>
      <p>3.1 FeruToys sells to both consumers and business customers.</p>
      <p>
      ...
      <p>
        5.4 FeruToys does not provide electrical engineering, installation, compliance, inspection,
      ...
      <p>
        ...
        FeruToys is general information only and must not be treated as a substitute for professional
      ...
      <p>
        7.3 A contract between you and FeruToys is formed only when we accept your order, process it for
      ...
      <p>
        ...
        differences are the responsibility of the customer and are not controlled by FeruToys.
      </p>
      ...
      <p>
        9.3 Payments are processed by secure third-party payment providers. FeruToys does not store your
      ...
      <p>
        10.1 From time to time, FeruToys may offer discounts, promotional codes, special prices, free
      ...
      <p>11.1 FeruToys dispatches orders from within the European Union.</p>
      <p>
      ...
      <table>
        ...
        <tbody>
          <tr><td>Estonia</td><td>1&ndash;3 business days</td></tr>
      ...
      <p>
        12.1 For deliveries outside the European Union, your order may be subject to customs clearance,
      ...
      <p>
        12.3 FeruToys has no control over customs processing times, customs decisions, import restrictions,
      ...
      <p>
        ...
        failure to comply with local requirements, FeruToys will not be responsible for the resulting loss,
      ...
      <p>
        14.4 To exercise your cancellation right, you must inform us clearly by email at info@ferutoys.com
      ...
      <p>
        17.3 For EU Consumers, statutory rights apply under applicable EU and Estonian consumer law, including the Estonian Law of Obligations Act (Võlaõigusseadus). These rights may
      ...
      <p>
        ...
        commercial warranty, additional warranty, or return policy offered by FeruToys.
      </p>
      <p>
      ...
      <p>18.1 FeruToys may offer paid additional warranty options for selected products.</p>
      ...
      <p>
        18.9 To make an Additional Warranty claim, you must contact us at info@ferutoys.com with your order
      ...
      <p>
        20.1 Products sold by FeruToys may be designed for specific markets, standards, voltage systems,
      ...
      <p>
        20.3 We do not guarantee that products purchased from FeruToys will meet every local building code,
      ...
      <p>
        ...
        descriptions, photographs, videos, design elements, and other materials, belongs to FeruToys,
        FERUTAX OÜ, suppliers, manufacturers, licensors, or other rights holders.
      </p>
      <p>
      ...
      <p>25.3 Subject to sections 25.1 and 25.2, FeruToys will not be liable for:</p>
      <ul>
      ...
      <p>30.1 These Terms are governed by the laws of the Republic of Estonia.</p>
      <p>
      ...
      <p>
        30.3 If you are a Consumer, disputes may be brought before the courts of Estonia or, where
        applicable law allows, before the courts of your country of residence. Estonian Consumers may also
        turn to the Consumer Disputes Committee of the Consumer Protection and Technical Regulatory
        Authority (Tarbijakaitse ja Tehnilise Järelevalve Amet, www.ttja.ee).
      </p>
      <p>
        30.4 Consumers resident in the European Union may also use the European Commission&rsquo;s Online
        Dispute Resolution platform at ec.europa.eu/odr. Nothing in these Terms prevents you from relying on
        mandatory consumer rights available in your country of residence.
      </p>
      <p>
        30.5 If you are a Business Customer, Harju County Court (Harju Maakohus) in Tallinn, Estonia will
        have exclusive jurisdiction over any dispute arising out of or in connection with these Terms, the
        Website, or any order.
      </p>
