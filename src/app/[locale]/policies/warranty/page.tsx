...
export const metadata = { title: "Warranty Policy — FeruToys" };
  ...
  return (
    <PolicyLayout title="Warranty Policy" lastUpdated="29 May 2026">
      <p>
        ...
        paid Additional Warranty options apply to products purchased through www.ferutoys.com.
      </p>
      ...
      <p>1.1 This Policy applies to physical goods purchased through FeruToys.</p>
      <p>
      ...
      <h2>3. Estonian Consumer Rights</h2>
      <p>
        3.1 If you are an Estonian Consumer, you may have statutory rights under the Estonian Consumer Protection Act and the Law of Obligations Act
      ...
      <p>5.2 Manufacturer warranty terms are set by the manufacturer, not by FeruToys.</p>
      <p>
      ...
      <p>
        5.5 FeruToys may assist with manufacturer warranty claims where reasonable, but we do not control
      ...
      <p>6.1 FeruToys may offer paid Additional Warranty options for selected products.</p>
      ...
      <p>11.1 To make a warranty claim, contact us at info@ferutoys.com.</p>
      ...
      <p>
        12.1 Warranty claims may require inspection by FeruToys, the manufacturer, supplier, service
      ...
      <p>
        ...
        may be covered by FeruToys where required by law or approved by us.
      </p>
      <p>
      ...
      <p>
        17.4 To the fullest extent permitted by law, FeruToys will not be liable to Business Customers for
