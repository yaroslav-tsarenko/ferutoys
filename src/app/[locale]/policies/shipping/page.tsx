...
export const metadata = { title: "Shipping Policy — FeruToys" };

export default function ShippingPolicyPage() {
  return (
    <PolicyLayout title="Shipping Policy" lastUpdated="29 May 2026">
      <p>
        This Shipping Policy explains how orders placed through www.ferutoys.com are processed,
        dispatched, delivered, and handled in the event of delivery issues.
      </p>
      <p>The Website is operated by:</p>
      <ContactBlock />
      <p>
        In this Policy, &ldquo;FeruToys&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo; or &ldquo;our&rdquo;
        means FERUTAX OÜ. &ldquo;Customer&rdquo;, &ldquo;you&rdquo; or &ldquo;your&rdquo; means the
      ...
      <p>1.1 This Policy applies to the delivery of physical goods purchased through FeruToys.</p>
      <p>
        1.2 FeruToys supplies electrical products, electrical materials, wiring accessories,
      ...
      <p>3.1 FeruToys dispatches orders from within the European Union.</p>
      <p>
      ...
      <p>
        4.2 Domestic Estonian orders may be delivered by Omniva, DPD, DHL, or another suitable domestic carrier
      ...
      <p>
        5.4 FeruToys is not responsible for delays caused by customs authorities, local postal operators,
      ...
      <p>
        7.3 FeruToys is not responsible for delays, failed deliveries, lost parcels, return charges, or
      ...
      <p>
        8.1 FeruToys may accept international orders to supported delivery destinations shown on the
      ...
      <p>
        9.1 Orders delivered outside the European Union may be subject to customs clearance, import duties,
      ...
      <p>
        9.3 FeruToys does not control customs authorities, import tax assessments, duty rates, customs
      ...
      <p>
        12.4 FeruToys is not responsible for failed delivery where you do not respond to courier notices, do
      ...
      <p>
        ...
        extended period, please contact us at info@ferutoys.com.
      </p>
      <p>
      ...
      <p>
        16.2 FeruToys is not responsible for loss, damage, delay, customs issues, onward shipping problems,
      ...
      <p>
        17.3 FeruToys is not responsible for labour costs, electrician costs, contractor costs, installation
